...
const testProfiles = [
  ...
  // ============================================================
  // TEST PAIR 1: SIMILAR TASTE (Both love Kendrick + Drake)
  // Expected similarity: ~90%+ (same hip-hop artists)
  // ============================================================
  {
    email: 'alex@test.onchord.app',
    password: 'TestPassword123!',
    displayName: 'Alex Thompson',
    username: 'hiphop_alex',
    avatar: 'https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?w=400',
    bio: 'Hip-hop is life. Kendrick, Drake, J. Cole - the holy trinity.',
    accentColor: '#FF5722',
    genre: 'Hip-Hop',
    reviews: [
      {
        ...
        albumCover: 'https://i.scdn.co/image/ab67616d0000b273d28d2ebdedb220e479743797',
        rating: 5,
        content: 'Perfect album. Every track tells a story. Swimming Pools is iconic.',
        mood: 'Nostalgic',
        tags: ['hip-hop', 'classic', 'storytelling'],
      },
      {
        albumId: '3cf4iSSKd8ffTncbtKljXw',
        albumTitle: 'Take Care',
        albumArtist: 'Drake',
        albumCover: 'https://i.scdn.co/image/ab67616d0000b2731f6a2a40bb692936879db730',
        rating: 5,
        content: 'Drake at his peak. Marvins Room, Headlines, The Motto - so many hits.',
        mood: 'Melancholic',
        tags: ['hip-hop', 'r&b', 'emotional'],
      },
      {
        albumId: '3CCnGldVQ90c26aB4wJj91',
        albumTitle: '2014 Forest Hills Drive',
        albumArtist: 'J. Cole',
        albumCover: 'https://i.scdn.co/image/ab67616d0000b2737a9d1b59b49a2a8784ef4f1c',
        rating: 5,
        content: 'Cole went platinum with no features. No Role Modelz is timeless.',
        mood: 'Inspired',
        tags: ['hip-hop', 'conscious', 'storytelling'],
      },
    ],
  },
  {
    email: 'jordan@test.onchord.app',
    password: 'TestPassword123!',
    displayName: 'Jordan Mitchell',
    username: 'hiphop_jordan',
    avatar: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=400',
    bio: 'Same artists, same vibes. Kendrick and Drake on repeat forever.',
    accentColor: '#E91E63',
    genre: 'Hip-Hop',
    reviews: [
      {
        ...
        albumCover: 'https://i.scdn.co/image/ab67616d0000b2738b52c6b9bc4e43d873869699',
        rating: 5,
        content: 'Pulitzer Prize winning! Kendrick is the greatest rapper alive.',
        mood: 'Energetic',
        tags: ['hip-hop', 'rap', 'award-winning'],
      },
      {
        albumId: '2lxaP1XyZpNpHxi4OWn9wC',
        albumTitle: 'Nothing Was the Same',
        albumArtist: 'Drake',
        albumCover: 'https://i.scdn.co/image/ab67616d0000b2730d8e93bc03f83b336e95c1c1',
        rating: 5,
        content: 'Started From The Bottom, Hold On Were Going Home - classic Drake era.',
        mood: 'Happy',
        tags: ['hip-hop', 'r&b', 'platinum'],
      },
      {
        albumId: '4Wv5UAieM1LDEYVq5WmqDd',
        albumTitle: 'KOD',
        albumArtist: 'J. Cole',
        albumCover: 'https://i.scdn.co/image/ab67616d0000b27348d03ef04b7a2da28a3c6b6c',
        rating: 4,
        content: 'J. Cole always delivers the message. Deep bars about addiction.',
        mood: 'Thoughtful',
        tags: ['hip-hop', 'conscious', 'deep'],
      },
    ],
  },
  // ============================================================
  // TEST PAIR 2: OPPOSITE TASTE (Metal vs Ambient/Classical)  
  // Expected similarity: ~20% or less (completely different genres)
  // ============================================================
  {
    email: 'mike@test.onchord.app',
    password: 'TestPassword123!',
    displayName: 'Mike Stone',
    username: 'metal_mike',
    avatar: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=400',
    bio: 'METAL OR NOTHING. Slayer, Megadeth, Pantera. Loud and proud 🤘',
    accentColor: '#B71C1C',
    genre: 'Metal',
    reviews: [
      {
        albumId: '1Dh27pjT3IEdiRG9Se5FQj',
        albumTitle: 'Reign in Blood',
        albumArtist: 'Slayer',
        albumCover: 'https://i.scdn.co/image/ab67616d0000b273c47e9aa0f8e3c3d4f5b6a7e8',
        rating: 5,
        content: '29 minutes of pure thrash perfection. Angel of Death is the heaviest opener ever.',
        mood: 'Aggressive',
        tags: ['metal', 'thrash', 'heavy'],
      },
      {
        albumId: '5tLpwYPCXHLMDnLGvIH2Kg',
        albumTitle: 'Rust in Peace',
        albumArtist: 'Megadeth',
        albumCover: 'https://i.scdn.co/image/ab67616d0000b2731f2d5c3e4a6b7c8d9e0f1a2b',
        rating: 5,
        content: 'Technical thrash at its finest. Holy Wars... The Punishment Due is insane.',
        mood: 'Energetic',
        tags: ['metal', 'thrash', 'technical'],
      },
      {
        albumId: '6EfxMVwBJQy4nZNdfnH2l9',
        albumTitle: 'Vulgar Display of Power',
        albumArtist: 'Pantera',
        albumCover: 'https://i.scdn.co/image/ab67616d0000b273d9e3f4a5b6c7d8e9f0a1b2c3',
        rating: 5,
        content: 'Walk and This Love are groove metal perfection. Dimebag was a god.',
        mood: 'Aggressive',
        tags: ['metal', 'groove', 'heavy'],
      },
    ],
  },
  {
    email: 'lisa@test.onchord.app',
    password: 'TestPassword123!',
    displayName: 'Lisa Chen',
    username: 'ambient_lisa',
    avatar: 'https://images.unsplash.com/photo-1580489944761-15a19d654956?w=400',
    bio: 'Soft piano and ambient textures only. Perfect for meditation and focus.',
    accentColor: '#81D4FA',
    genre: 'Ambient/Classical',
    reviews: [
      {
        albumId: '7aJuG4TFXa2hmE4z1yxc3n',
        albumTitle: 'Ambient 1: Music for Airports',
        albumArtist: 'Brian Eno',
        albumCover: 'https://i.scdn.co/image/ab67616d0000b2737b8e9f8c6d5a4b3c2a1e0f9d',
        rating: 5,
        content: 'The foundation of ambient music. Pure sonic meditation.',
        mood: 'Peaceful',
        tags: ['ambient', 'experimental', 'calming'],
      },
      {
        albumId: '3NZl0v2G6HdN9xnRYr9I0j',
        albumTitle: 'Felt',
        albumArtist: 'Nils Frahm',
        albumCover: 'https://i.scdn.co/image/ab67616d0000b2731f7a8f3e4d5c6b7a8e9d0c1f',
        rating: 5,
        content: 'Intimate piano recorded with felt on the hammers. So delicate and beautiful.',
        mood: 'Calm',
        tags: ['neo-classical', 'piano', 'intimate'],
      },
      {
        albumId: '6FZDfxM1T0O8Mz3Q4kS5xT',
        albumTitle: 'Selected Ambient Works 85-92',
        albumArtist: 'Aphex Twin',
        albumCover: 'https://i.scdn.co/image/ab67616d0000b273a3d4e5f6b7c8d9e0f1a2b3c4',
        rating: 5,
        content: 'Dreamy, otherworldly electronic soundscapes. Xtal is pure bliss.',
        mood: 'Dreamy',
        tags: ['ambient', 'electronic', 'ethereal'],
      },
    ],
  },
];
