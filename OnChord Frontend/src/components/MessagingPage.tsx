                ...
                <div className="w-full max-w-[760px] mx-auto">
                  {selectedImage && (
                    <div className="mb-2 relative w-fit">
                      <img src={selectedImage} alt="Selected" className="w-8 h-8 rounded-md border border-primary object-cover" />
                      <Button
                        size="sm"
                        variant="ghost"
                        onClick={() => setSelectedImage(null)}
                        className="absolute -top-1 -right-1 bg-destructive hover:bg-destructive/90 text-destructive-foreground rounded-full w-3.5 h-3.5 p-0 flex items-center justify-center"
                      >
